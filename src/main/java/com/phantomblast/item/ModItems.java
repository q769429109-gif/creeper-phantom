...
public final class ModItems {
    ...
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(PhantomBlast.MODID);
     ...
     * 苦力怕幻翼刷怪蛋。
     *
     * <p>第一个参数传的是 {@code ModEntities.BLAST_PHANTOM} 这个
