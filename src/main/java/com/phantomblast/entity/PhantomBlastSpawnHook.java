...
/**
 * 把 {@link PhantomBlastSpawner} 挂进 {@code ServerLevel}。
 *
 * <h2>为什么需要这一层</h2>
...
public final class PhantomBlastSpawnHook {
    ...
    public static void onModifyCustomSpawners(ModifyCustomSpawnersEvent event) {
        ...
        event.addCustomSpawner(new PhantomBlastSpawner());
    }

    private PhantomBlastSpawnHook() {
    }
}
