package com.phantomblast.config;
 ...
 * 幻翼爆破配置。
 *
 * <p>文件位置：{@code config/phantomblast-common.toml}（COMMON 类型，固定路径）。</p>
 *
 * <h2>爆炸默认值</h2>
 ...
 */
public final class PhantomBlastConfig {
    ...
    static {
        ...
        b.comment("幻翼爆破 Phantom Blast —— 苦力怕幻翼俯冲击中玩家时引爆苦力怕级爆炸").push("general");
