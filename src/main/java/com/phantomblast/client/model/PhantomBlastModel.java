package com.phantomblast.client.model;
 ...
 */
public class PhantomBlastModel extends HierarchicalModel<PhantomBlastEntity> {

    /**
     * 模型图层：客户端启动期注册，渲染器用 {@code ctx.bakeLayer(LAYER)} 取。
     *
     * <p>路径是本模组自己的命名空间（{@code phantomblast:creeperphantom}），
     * <b>不会</b>和原版的 {@code minecraft:phantom} 图层撞车 ——
     * 原版幻翼继续用它自己那份模型。</p>
     */
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(PhantomBlast.MODID, "creeperphantom"), "main");
    ...
    public PhantomBlastModel(ModelPart root) {
        this.root = root;
     ...
     */
    @Override
    public void setupAnim(PhantomBlastEntity entity, float limbSwing, float limbSwingAmount,
