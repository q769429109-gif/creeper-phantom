 ...
 * 模型的几何数据（{@link HybridCreeperModel}）和贴图。</p>
 *
 * <h2>为什么不用 {@code PhantomRenderer} 的泛型放宽</h2>
 * <p>虽然 {@code HybridCreeperEntity} 是 {@code Phantom} 的子类，
...
public class HybridCreeperRenderer extends MobRenderer<HybridCreeperEntity, HybridCreeperModel> {
    ...
    /** 与 {@code src/main/resources/assets/hybridcreeper/textures/entity/creeperphantom.png} 对应。 */
    public static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HybridCreeper.MODID, "textures/entity/creeperphantom.png");
    ...
    @Override
    public ResourceLocation getTextureLocation(HybridCreeperEntity entity) {
        return TEXTURE;
    }
     ...
     */
    @Override
    protected void scale(HybridCreeperEntity entity, PoseStack poseStack, float partialTick) {
     ...
     */
    @Override
    protected void setupRotations(HybridCreeperEntity entity, PoseStack poseStack, float ageInTicks,
